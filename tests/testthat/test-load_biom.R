...
test_that("the TreeSummarizedExperiment has expected taxonomic ranks", {
  expect_identical(mia::taxonomyRanks(result), c("Superkingdom", "Clade", "Class", "Order", "Family"))
})
